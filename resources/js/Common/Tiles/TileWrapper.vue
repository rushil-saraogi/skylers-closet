<template>
    <div
        class="bg-white border shadow-sm hover:shadow-md transition-all md:max-w-xs flex flex-col justify-between duration-200 rounded-lg relative hover:cursor-grab h-full"
